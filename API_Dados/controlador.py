...
if __name__ == "__main__":
    try:
        ...
        crud.create_user(session, "João", "joao@example.com")
        crud.create_user(session, "Maria", "maria@example.com")
        ...
        print("\n--- Atualizar Usuário ---")
        crud.update_user(session, 1, "João Silva", "joaosilva@example.com")
